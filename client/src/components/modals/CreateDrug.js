    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                <Form>
                    <Dropdown className="mt-2 mb-2">
                        <Dropdown.Toggle>{drug.selectedType.name || "Виберіть тип"}</Dropdown.Toggle>
                        <Dropdown.Menu>
                            {drug.types.map(type =>
                                <Dropdown.Item
                    ...
                    <Form.Control
                        ...
                        className="mt-3"
                        placeholder="Введіть назву медикаменту"
                    />
                    <Form.Control
                        value={price}
                        onChange={e => setPrice(Number(e.target.value))}
                        className="mt-3"
                        placeholder="Введіть ціну медикаменту"
                        type="number"
                    />
                    <Form.Control
                        className="mt-3"
            ...
            <Modal.Footer>
                ...
                <Button variant="outline-success" onClick={addDrug}>Додати</Button>{' '}
            </Modal.Footer>
        </Modal>
    );
});
